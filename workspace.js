...
import { TAB_CONFIG, TABS, PLAYER_ROLES, AWARD_TYPES, AWARD_BOTTOM } from '../utils/constants.js';
...
export function renderWorkspace(app, navigate, params = {}) {
        ...
        <div class="workspace-header">
          <div class="workspace-header-left">
            ...
            <div class="workspace-title-block">
              ...
              ${isAdmin ? '<span class="badge badge-admin" style="margin-top:6px;display:inline-block">Admin Layer Access Mode</span>' : ''}
            </div>
          </div>
          <div class="nav-tabs" id="navTabs" style="flex:1;justify-content:flex-start;margin-left:var(--sp-2)">
            ${TAB_CONFIG.map(t => `
  ...
  function battingRowHTML(b = {}, idx = 0) {
    return `
      <div class="form-row form-row-5" style="margin-bottom:var(--sp-2)" data-batting-row>
  ...
  function renderMeetingList(container) {
    ...
    container.innerHTML = `
      ...
      <div class="meetings-grid" style="display:grid; grid-template-columns: 1fr 1fr; gap:var(--sp-4);">
        ${meetings.length === 0
