import{r as t,n as e,C as n,_ as a,R as i,Y as r,F as o,g as s,b as c,d as u,V as l,Z as d,j as f,$ as p,L as m,a0 as g}from"./index.esm2017-DYQOIUAv.js";const h="@firebase/installations",w="0.6.18",y=1e4,I=`w:${w}`,v="FIS_v2",b=36e5,T=new i("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function C(t){return t instanceof o&&t.code.includes("request-failed")}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t);return F.test(e)?e:""}catch(t){return""}}function x(t){return`${t.appName}!${t.appId}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const N="firebase-installations-store";let _=null;function L(){return _||(_=r("firebase-installations-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(N)}})),_}async function K(t,e){const n=x(t),a=(await L()).transaction(N,"readwrite"),i=a.objectStore(N),r=await i.get(n);return await i.put(e,n),await a.done,r&&r.fid===e.fid||E(t,e.fid),e}async function R(t){const e=x(t),n=(await L()).transaction(N,"readwrite");await n.objectStore(N).delete(e),await n.done}async function U(t,e){const n=x(t),a=(await L()).transaction(N,"readwrite"),i=a.objectStore(N),r=await i.get(n),o=e(r);return void 0===o?await i.delete(n):await i.put(o,n),await a.done,!o||r&&r.fid===o.fid||E(t,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function B(t){let e;const n=await U(t.appConfig,n=>{const a=function(t){const e=t||{fid:M(),registrationStatus:0};return G(e)}(n),i=function(t,e){if(0===e.registrationStatus){if(!navigator.onLine){return{installationEntry:e,registrationPromise:Promise.reject(T.create("app-offline"))}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},a=async function(t,e){try{const n=await async function({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const a=S(t),i=$(t),r=e.getImmediate({optional:!0});if(r){const t=await r.getHeartbeatsHeader();t&&i.append("x-firebase-client",t)}const o={fid:n,authVersion:v,appId:t.appId,sdkVersion:I},s={method:"POST",headers:i,body:JSON.stringify(o)},c=await D(()=>fetch(a,s));if(c.ok){const t=await c.json();return{fid:t.fid||n,registrationStatus:2,refreshToken:t.refreshToken,authToken:k(t.authToken)}}throw await j("Create Installation",c)}(t,e);return K(t.appConfig,n)}catch(n){throw C(n)&&409===n.customData.serverCode?await R(t.appConfig):await K(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}(t,n);return{installationEntry:n,registrationPromise:a}}return 1===e.registrationStatus?{installationEntry:e,registrationPromise:V(t)}:{installationEntry:e}}(t,a);return e=i.registrationPromise,i.installationEntry});return""===n.fid?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}async function V(t){let e=await H(t.appConfig);for(;1===e.registrationStatus;)await A(100),e=await H(t.appConfig);if(0===e.registrationStatus){const{installationEntry:e,registrationPromise:n}=await B(t);return n||e}return e}function H(t){return U(t,t=>{if(!t)throw T.create("installation-not-found");return G(t)})}function G(t){return 1===(e=t).registrationStatus&&e.registrationTime+y<Date.now()?{fid:t.fid,registrationStatus:0}:t;var e;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function W({appConfig:t,heartbeatServiceProvider:e},n){const a=function(t,{fid:e}){return`${S(t)}/${e}/authTokens:generate`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,n),i=P(t,n),r=e.getImmediate({optional:!0});if(r){const t=await r.getHeartbeatsHeader();t&&i.append("x-firebase-client",t)}const o={installation:{sdkVersion:I,appId:t.appId}},s={method:"POST",headers:i,body:JSON.stringify(o)},c=await D(()=>fetch(a,s));if(c.ok){return k(await c.json())}throw await j("Generate Auth Token",c)}async function J(t,e=!1){let n;const a=await U(t.appConfig,a=>{if(!Z(a))throw T.create("not-registered");const i=a.authToken;if(!e&&function(t){return 2===t.requestStatus&&!function(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+b}(t)}(i))return a;if(1===i.requestStatus)return n=async function(t,e){let n=await Y(t.appConfig);for(;1===n.authToken.requestStatus;)await A(100),n=await Y(t.appConfig);const a=n.authToken;return 0===a.requestStatus?J(t,e):a}(t,e),a;{if(!navigator.onLine)throw T.create("app-offline");const e=function(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}(a);return n=async function(t,e){try{const n=await W(t,e),a=Object.assign(Object.assign({},e),{authToken:n});return await K(t.appConfig,a),n}catch(n){if(!C(n)||401!==n.customData.serverCode&&404!==n.customData.serverCode){const n=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await K(t.appConfig,n)}else await R(t.appConfig);throw n}}(t,e),e}});return n?await n:a.authToken}function Y(t){return U(t,t=>{if(!Z(t))throw T.create("not-registered");const e=t.authToken;return 1===(n=e).requestStatus&&n.requestTime+y<Date.now()?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t;var n;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})}function Z(t){return void 0!==t&&2===t.registrationStatus}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Q(t,e=!1){const n=t;await async function(t){const{registrationPromise:e}=await B(t);e&&await e}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n);return(await J(n,e)).token}function X(t){return T.create("missing-app-config-values",{valueName:t})}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(t){this.app=t}_delete(){return delete bt[this.app.options.appId],Promise.resolve()}}let bt={},Tt=[];const Ct={};let St,kt,jt="dataLayer",$t="gtag",Pt=!1;function Dt(t){if(Pt)throw rt.create("already-initialized");t.dataLayerName&&(jt=t.dataLayerName),t.gtagName&&($t=t.gtagName)}function At(t,e,n){!function(){const t=[];if(l()&&t.push("This is a browser extension environment."),d()||t.push("Cookies are not available."),t.length>0){const e=t.map((t,e)=>`(${e+1}) ${t}`).join(" "),n=rt.create("invalid-analytics-context",{errorInfo:e});it.warn(n.message)}}();const a=t.options.appId;if(!a)throw rt.create("no-app-id");if(!t.options.apiKey){if(!t.options.measurementId)throw rt.create("no-api-key");it.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`)}if(null!=bt[a])throw rt.create("already-exists",{id:a});if(!Pt){!function(t){let e=[];Array.isArray(window[t])?e=window[t]:window[t]=e}(jt);const{wrappedGtag:t,gtagCore:e}=function(t,e,n,a,i){let r=function(...t){window[a].push(arguments)};return window[i]&&"function"==typeof window[i]&&(r=window[i]),window[i]=ut(r,t,e,n),{gtagCore:r,wrappedGtag:window[i]}}(bt,Tt,Ct,jt,$t);kt=t,St=e,Pt=!0}bt[a]=It(t,Tt,Ct,e,St,jt,n);return new vt(t)}function Ft(t=c()){t=s(t);const e=a(t,nt);return e.isInitialized()?e.getImmediate():Mt(t)}function Mt(t,e={}){const n=a(t,nt);if(n.isInitialized()){const t=n.getImmediate();if(u(e,n.getOptions()))return t;throw rt.create("already-initialized")}return n.initialize({options:e})}async function xt(){if(l())return!1;if(!d())return!1;if(!f())return!1;try{return await p()}catch(t){return!1}}function qt(t,e,n){t=s(t),async function(t,e,n,a){if(a&&a.global)return t("set",{screen_name:n}),Promise.resolve();t("config",await e,{update:!0,screen_name:n})}(kt,bt[t.app.options.appId],e,n).catch(t=>it.error(t))}async function Et(t){return t=s(t),async function(t,e){const n=await e;return new Promise((e,a)=>{t("get",n,"client_id",t=>{t||a(rt.create("no-client-id")),e(t)})})}(kt,bt[t.app.options.appId])}function Ot(t,e,n){t=s(t),async function(t,e,n,a){if(a&&a.global)return t("set",{user_id:n}),Promise.resolve();t("config",await e,{update:!0,user_id:n})}(kt,bt[t.app.options.appId],e,n).catch(t=>it.error(t))}function zt(t,e,n){t=s(t),async function(t,e,n,a){if(a&&a.global){const e={};for(const t of Object.keys(n))e[`user_properties.${t}`]=n[t];return t("set",e),Promise.resolve()}t("config",await e,{update:!0,user_properties:n})}(kt,bt[t.app.options.appId],e,n).catch(t=>it.error(t))}function Nt(t,e){t=s(t),async function(t,e){const n=await t;window[`ga-disable-${n}`]=!e}(bt[t.app.options.appId],e).catch(t=>it.error(t))}function _t(t){kt?kt("set",t):yt(t)}function Lt(t,e,n,a){t=s(t),async function(t,e,n,a,i){if(i&&i.global)t("event",n,a);else{const i=await e;t("event",n,Object.assign(Object.assign({},a),{send_to:i}))}}(kt,bt[t.app.options.appId],e,n,a).catch(t=>it.error(t))}function Kt(t){kt?kt("consent","update",t):wt(t)}const Rt="@firebase/analytics",Ut="0.10.17";e(new n(nt,(t,{options:e})=>At(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),e),"PUBLIC")),e(new n("analytics-internal",function(t){try{const e=t.getProvider(nt).getImmediate();return{logEvent:(t,n,a)=>Lt(e,t,n,a)}}catch(e){throw rt.create("interop-component-reg-failed",{reason:e})}},"PRIVATE")),t(Rt,Ut),t(Rt,Ut,"esm2017");export{Ft as getAnalytics,Et as getGoogleAnalyticsClientId,Mt as initializeAnalytics,xt as isSupported,Lt as logEvent,Nt as setAnalyticsCollectionEnabled,Kt as setConsent,qt as setCurrentScreen,_t as setDefaultEventParameters,Ot as setUserId,zt as setUserProperties,Dt as settings};
